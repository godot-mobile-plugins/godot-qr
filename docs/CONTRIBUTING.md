![Android CI](https://github.com/godot-mobile-plugins/godot-qr/actions/workflows/android-ci.yml/badge.svg)
![iOS CI](https://github.com/godot-mobile-plugins/godot-qr/actions/workflows/ios-ci.yml/badge.svg)

# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="28"> Contributing

Thank you for your interest in contributing to the Godot QR Plugin! This guide will help you understand the project structure, build processes, and development workflows.

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Project structure
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Build System Architecture
...
println(pluginConfig.pluginName)        // "QRPlugin"
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Build Customization
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Local Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Development Workflow

### Initial Setup

1. **Clone the repository:**
   ```bash
   git clone https://github.com/godot-mobile-plugins/godot-qr.git
   cd godot-qr
   ```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Building
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Cross-Platform Builds
...
- **Release archive:** `release/QRPlugin-*-v*.zip`

---

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Android Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> iOS Builds
...
- **Plugin XCFrameworks:** `ios/build/framework/QRPlugin.debug.xcframework`, `QRPlugin.release.xcframework`
- **Release archive:** `release/QRPlugin-iOS-v*.zip`
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Testing
...
|------|----------|---------|
| `QRTests.swift` | Swift | `QR` class — init, `isActiveKey`, `onThisHappened` callback, ObjC bridging, concurrency |
| `QRLoggerTests.mm` | Objective-C++ | `qr_log` global — initialization, all log levels, format string handling |

The tests are compiled into the `qr_plugin_tests` Xcode test bundle target, which declares a dependency on the main `qr_plugin` static library target. The Xcode scheme used by the build system is `qr_plugin_tests`.
...
| Concern | Detail |
|---------|--------|
| Target name | `qr_plugin_tests` |
| Product type | `com.apple.product-type.bundle.unit-test` |
| Scheme file | `ios/plugin.xcodeproj/xcshareddata/xcschemes/qr_plugin_tests.xcscheme` |
| Linked library | `libqr_plugin.a` (the main plugin target) |
| Target dependency | `qr_plugin` (built before tests run) |
| Header search paths | `$(SRCROOT)/src`, `$(CONFIGURATION_TEMP_DIR)/qr_plugin.build/DerivedSources` |

#### Writing new iOS tests

Swift tests: add a new `XCTestCase` subclass to `ios/test/unit/` and register the file in the `qr_plugin_tests` target's Sources build phase in `project.pbxproj`.

Objective-C++ tests: add a `.mm` file to `ios/test/unit/`. Import `qr_logger.h` for logger access or `qr_plugin.h` for the plugin class. Add the file to the Sources build phase the same way.

> **Note on Godot engine classes:** `QRPlugin` (the `Object` subclass), `qr_plugin_init()`, and `qr_plugin_deinit()` all depend on `memnew`/`memdelete` and `Engine::get_singleton()`, which are Godot engine internals unavailable in a plain XCTest host. Test those paths using GDScript integration tests via the Godot editor or the [GUT](https://github.com/bitwes/Gut) framework instead.
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Creating Releases
...
This creates:
- `release/QRPlugin-Android-v*.zip`
- `release/QRPlugin-iOS-v*.zip`
- `release/QRPlugin-Multi-v*.zip` (combined)
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> GitHub Actions Workflows
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="20"> Installing to Your Project

```bash
# Using install script
./script/install.sh -t /path/to/your/project -z /path/to/QRPlugin-*.zip

# Example
./script/install.sh -t ~/MyGame -z release/QRPlugin-Multi-v6.0.zip
```

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Troubleshooting
...
#   ios/plugin.xcodeproj/xcshareddata/xcschemes/qr_plugin_tests.xcscheme
# and the test target must be listed in the targets array of project.pbxproj.
# Verify both are present:
find ios/plugin.xcodeproj -name "qr_plugin_tests.xcscheme"
grep "qr_plugin_tests" ios/plugin.xcodeproj/project.pbxproj
```

**Problem:** iOS tests fail with "module not found" or linker errors
```bash
# The test target links against libqr_plugin.a.
...
```bash
# Tests that exercise QRPlugin (the Godot Object subclass) or the
...
- Check existing [GitHub Issues](https://github.com/godot-mobile-plugins/godot-qr/issues)
- Check exısting [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-qr/discussions)
- Review [Godot documentation](https://docs.godotengine.org/)

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-qr/main/addon/src/main/icon.png" width="24"> Additional Resources
